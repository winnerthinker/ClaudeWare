...
public class ArrayList extends Module {
    ...
    private void drawLegitRoundedRect(double x, double y, double w, double h, double radius, int color) {
        ...
        // Fill drawn without GL_POLYGON_SMOOTH: polygon smoothing applies per-triangle
        // edge anti-aliasing, so every internal spoke of the fan gets blended down to
        // ~50% alpha and the fill is no longer uniformly opaque.
        ...
        // Smoothed outline layered on top to keep the rounded edges clean
